...
SVC_NAME="actions.runner.sankha-ghosh-wordpress-on-aws.ip-172-31-29-110.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (sankha-ghosh-wordpress-on-aws.ip-172-31-29-110)"
